...
const MyPortfolio = () => {
    return (
        <div className='container my-5'>
            <div>
                <h3 className='my-2 text-info'>About me</h3>
            ...
            <div className='my-4'>
                <h3 className='mb-2 text-info'>Education</h3>
            ...
            <div className='my-4'>
                <h3 className='mb-2 text-info'>Skills</h3>
                <div>
            ...
            <div className='my-4'>
                <h3 className='mb-2 text-info'>Projects</h3>
            ...
            <div className='my-4'>
                <h3 className='mb-2 text-info'>Declaration</h3>
